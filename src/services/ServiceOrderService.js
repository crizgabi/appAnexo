...
export const ServiceOrderService = {
    ...
    async find(id, dbEnvKey, dbType) {
        ...
        return {
            ...
            idTecnicoResponsavel: os.IDTECNICO ?? os.FKTECNICO ?? r.idTecnicoResponsavel ?? null,
            nomeTecnicoResponsavel: os.NOMETECNICO ?? os.NMTECNICO ?? r.nomeTecnicoResponsavel ?? null,
